...
class TutorialDialog(QDialog):
    ...
    def _load_tutorials(self):
        ...
        basic_tutorial = {
            ...
            "description": "Learn how to create a simple workflow with action and script steps.",
            "difficulty": "Beginner",
            "estimated_time": "5 minutes",
            "steps": [
                TutorialStep(
                    title="Welcome to the Tutorial",
                    description="This tutorial will guide you through creating your first Moveworks workflow. Click 'Next' to continue.",
                    auto_advance=False
                ),
                TutorialStep(
                    title="Add Your First Action Step",
                    description="Click the 'Add Action Step' button to add your first action to the workflow.",
                ...
                TutorialStep(
                    ...
                    description="Congratulations! You've created your first workflow step. Continue exploring to learn more features.",
                    auto_advance=False
                )
            ]
        }
